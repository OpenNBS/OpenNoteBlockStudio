function draw_window_preferences() {
	...
	if (selected_tab = 0) {
		...
		if (draw_checkbox(x1 + 40, y1 + 290 + 62 + 16 + 20, presencewindow, "Show window status", "Displays which window you're on in Rich Presence.", !presence)) presencewindow = !presencewindow
