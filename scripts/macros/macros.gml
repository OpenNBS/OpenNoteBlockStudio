...
#macro data_directory		directory_get_current_working() + condstr(os_type != os_windows, "data", "Data") + condstr(os_type = os_windows, "\\", "/")
#macro sounds_directory		data_directory + condstr(os_type = os_linux, "sounds", "Sounds") + condstr(os_type = os_windows, "\\", "/")
#macro songs_directory		directory_get_current_working() + condstr(os_type != os_windows, "songs", "Songs") + condstr(os_type = os_windows, "\\", "/")
#macro pattern_directory	directory_get_current_working() + condstr(os_type != os_windows, "patterns", "Patterns") + condstr(os_type = os_windows, "\\", "/")
