...
#macro songs_directory		data_directory + "Songs" + condstr(os_type = os_windows, "\\", "/")
#macro pattern_directory	data_directory + "Patterns" + condstr(os_type = os_windows, "\\", "/")
