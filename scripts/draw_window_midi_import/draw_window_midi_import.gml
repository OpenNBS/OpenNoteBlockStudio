function draw_window_midi_import() {
	...
	draw_text_dynamic(x1 + 300, y1 + 52, "Max. channel height:")
	...
	if (draw_checkbox(x1 + 300, y1 + 112, w_midi_precision, "双倍节奏", "是否将节奏加倍以变的更精准。") && wmenu = 0) w_midi_precision=!w_midi_precision
