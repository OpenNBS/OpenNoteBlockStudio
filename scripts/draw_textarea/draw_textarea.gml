function draw_textarea(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	if (theme = 0) {
		...
		draw_sprite(spr_textbox_f, 0 + 8 * on + 16 * focus, xx, yy)
	    draw_sprite_ext(spr_textbox_f, 1 + 8 * on + 16 * focus, xx, yy + 2, 1, (h - 4) / 2, 0, -1, 1)
	    draw_sprite(spr_textbox_f, 2 + 8 * on + 16 * focus, xx, yy + h - 2)
	    draw_sprite_ext(spr_textbox_f, 3 + 8 * on + 16 * focus, xx + 2, yy + h - 2, (w - 4) / 2, 1, 0, -1, 1)
	    draw_sprite(spr_textbox_f, 4 + 8 * on + 16 * focus, xx + w - 2, yy + h - 2)
	    draw_sprite_ext(spr_textbox_f, 5 + 8 * on + 16 * focus, xx + w - 2, yy + 2, 1, (h - 4) / 2, 0, -1, 1)
	    draw_sprite(spr_textbox_f, 6 + 8 * on + 16 * focus, xx + w - 2, yy)
	    draw_sprite_ext(spr_textbox_f, 7 + 8 * on + 16 * focus, xx + 2, yy, (w - 4) / 2, 1, 0, -1, 1)
	} else {
