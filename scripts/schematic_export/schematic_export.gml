function schematic_export() {
	...
	with (create(obj_dummy2)) {
		...
		TAG_List("palette", 21 + insnum * 26, 10)
		...
		TAG_List("blocks", hei * len * wid, 10)
			TAG_Compound("nbt")
			...
			for (c = 0; c < hei; c += 1) {
			    for (a = 0; a < len; a += 1) {
			        for (b = wid - 1; b >= 0; b -= 1) {
						...
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 1) TAG_Int("state", insnum * 26 + 5)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 1 + 4) TAG_Int("state", insnum * 26 + 6)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 1 + 4 * 2) TAG_Int("state", insnum * 26 + 7)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 1 + 4 * 3) TAG_Int("state", insnum * 26 + 8)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 3) TAG_Int("state", insnum * 26 + 9)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 3 + 4) TAG_Int("state", insnum * 26 + 10)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 3 + 4 * 2) TAG_Int("state", insnum * 26 + 11)
						else if (sch_block_read(a, b, c) = 93 && sch_data_read(a, b, c) = 3 + 4 * 3) TAG_Int("state", insnum * 26 + 12)
						else if (sch_block_read(a, b, c) = 94) TAG_Int("state", insnum * 26 + 13)
						else if (sch_block_read(a, b, c) = 75) TAG_Int("state", insnum * 26 + 14)
						else if (sch_block_read(a, b, c) = 76) TAG_Int("state", insnum * 26 + 15)
