function draw_scrollbar(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	...
	if (sb_dir[i] = 0) {
	    ...
	    if (!locked) {
			...
			draw_sprite_ext(spr_scrollbar_h_bar_fill,(theme * 3) + ind + (fdark && theme = 3) * 3, xx + 20 + bpos, yy, floor(bwh) - 4, 1, 0, -1, 1)
			if (theme != 3) {
			...
			draw_sprite(spr_scrollbar_h_bar_right, (theme * 3) + ind + (fdark && theme = 3) * 3, xx + 17 + bpos + ceil(bwh - 2), yy)	
