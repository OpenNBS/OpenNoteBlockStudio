function draw_window() {
	...
	if (theme = 3 && sml = 0) {
		draw_sprite_ext(spr_shadow, 0, x1 - 16, y1 - 16, 1, 1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 1, x1 - 16, y1, 1, y2 - y1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 2, x1 - 16, y2, 1, 1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 3, x1, y2, x2 - x1, 1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 4, x2, y2, 1, 1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 5, x2, y1, 1, y2 - y1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 6, x2, y1 - 16, 1, 1, 0, -1 + fdark, 1)
		draw_sprite_ext(spr_shadow, 7, x1 - 16, y1 - 16, x2 - x1, 1, 0, -1 + fdark, 1)
	}
